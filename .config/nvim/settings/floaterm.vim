...
hi FloatermBorder guifg=Orange guibg=#61afef
...
nnoremap <silent> <F33> :FloatermKill<CR>:FloatermPrev<CR>
tnoremap <silent> <F33> <C-\><C-n>:FloatermKill<CR>:FloatermPrev<CR>
